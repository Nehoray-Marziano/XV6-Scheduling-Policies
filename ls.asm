...
main(int argc, char *argv[])
{
  ...
  3f:	6a 00                	push   $0x0
  41:	e8 3c 05 00 00       	call   582 <exit>
    ls(".");
  46:	83 ec 0c             	sub    $0xc,%esp
  49:	68 90 0a 00 00       	push   $0xa90
  4e:	e8 ad 00 00 00       	call   100 <ls>
    exit(0);
  53:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  5a:	e8 23 05 00 00       	call   582 <exit>
  5f:	90                   	nop
