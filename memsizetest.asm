...
main(int argc, char *argv[]){
   ...
   f:	e8 6e 03 00 00       	call   382 <memsize>
  14:	83 ec 04             	sub    $0x4,%esp
  17:	50                   	push   %eax
  18:	68 a8 07 00 00       	push   $0x7a8
  1d:	6a 01                	push   $0x1
  1f:	e8 2c 04 00 00       	call   450 <printf>
    double* i= malloc((sizeof(double))*2560);
  24:	c7 04 24 00 50 00 00 	movl   $0x5000,(%esp)
  2b:	e8 80 06 00 00       	call   6b0 <malloc>
  30:	89 c3                	mov    %eax,%ebx
    printf(1,"Allocating more memory\n");
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	68 c3 07 00 00       	push   $0x7c3
  39:	6a 01                	push   $0x1
  3b:	e8 10 04 00 00       	call   450 <printf>
    printf(1,"The process is using: %dB\n",memsize());
  40:	e8 3d 03 00 00       	call   382 <memsize>
  45:	83 c4 0c             	add    $0xc,%esp
  48:	50                   	push   %eax
  49:	68 a8 07 00 00       	push   $0x7a8
  4e:	6a 01                	push   $0x1
  50:	e8 fb 03 00 00       	call   450 <printf>
    free(i);
  55:	89 1c 24             	mov    %ebx,(%esp)
  58:	e8 c3 05 00 00       	call   620 <free>
    printf(1,"Freeing memory\n");
  5d:	59                   	pop    %ecx
  5e:	5b                   	pop    %ebx
  5f:	68 db 07 00 00       	push   $0x7db
  64:	6a 01                	push   $0x1
  66:	e8 e5 03 00 00       	call   450 <printf>
    printf(1,"The process is using: %dB\n", memsize());
  6b:	e8 12 03 00 00       	call   382 <memsize>
  70:	83 c4 0c             	add    $0xc,%esp
  73:	50                   	push   %eax
  74:	68 a8 07 00 00       	push   $0x7a8
  79:	6a 01                	push   $0x1
  7b:	e8 d0 03 00 00       	call   450 <printf>
    exit(0);
  80:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  87:	e8 56 02 00 00       	call   2e2 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb eb 07 00 00       	mov    $0x7eb,%ebx
        while(*s != 0){
 ...
 621:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 777:	0a 00 00 
 77a:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 a0 0a 00 00       	mov    $0xaa0,%eax
 789:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 790:	00 00 00 
