...
main(int argc, char *argv[])
{
  ...
  4e:	6a 00                	push   $0x0
  50:	e8 8d 02 00 00       	call   2e2 <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  55:	50                   	push   %eax
  56:	ff 33                	pushl  (%ebx)
  58:	68 bf 07 00 00       	push   $0x7bf
  5d:	6a 02                	push   $0x2
  5f:	e8 ec 03 00 00       	call   450 <printf>
      break;
  ...
  69:	52                   	push   %edx
  6a:	52                   	push   %edx
  6b:	68 a8 07 00 00       	push   $0x7a8
  70:	6a 02                	push   $0x2
  72:	e8 d9 03 00 00       	call   450 <printf>
    exit(0);
  77:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  7e:	e8 5f 02 00 00       	call   2e2 <exit>
  83:	66 90                	xchg   %ax,%ax
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
