...
main(void)
{
  ...
  73:	6a 00                	push   $0x0
  75:	e8 f0 02 00 00       	call   36a <wait>
  ...
  b3:	50                   	push   %eax
  b4:	50                   	push   %eax
  b5:	68 28 0b 00 00       	push   $0xb28
  ba:	68 56 08 00 00       	push   $0x856
  bf:	e8 d6 02 00 00       	call   39a <exec>
      printf(1, "init: exec sh failed\n");
  c4:	5a                   	pop    %edx
  c5:	59                   	pop    %ecx
  c6:	68 59 08 00 00       	push   $0x859
  cb:	6a 01                	push   $0x1
  cd:	e8 fe 03 00 00       	call   4d0 <printf>
      exit(0);
  d2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  d9:	e8 84 02 00 00       	call   362 <exit>
    mknod("console", 1, 1);
  de:	50                   	push   %eax
  df:	6a 01                	push   $0x1
  e1:	6a 01                	push   $0x1
  e3:	68 28 08 00 00       	push   $0x828
  e8:	e8 bd 02 00 00       	call   3aa <mknod>
    open("console", O_RDWR);
  ed:	58                   	pop    %eax
  ee:	5a                   	pop    %edx
  ef:	6a 02                	push   $0x2
  f1:	68 28 08 00 00       	push   $0x828
  f6:	e8 a7 02 00 00       	call   3a2 <open>
