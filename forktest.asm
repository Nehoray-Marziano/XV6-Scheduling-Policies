  ...
  54:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  59:	68 9c 04 00 00       	push   $0x49c
  5e:	e8 9d 01 00 00       	call   200 <strlen>
  63:	83 c4 0c             	add    $0xc,%esp
  66:	50                   	push   %eax
  67:	68 9c 04 00 00       	push   $0x49c
  6c:	6a 01                	push   $0x1
  6e:	e8 7f 03 00 00       	call   3f2 <write>
  ...
  a3:	6a 00                	push   $0x0
  a5:	e8 30 03 00 00       	call   3da <wait>
  ...
  f3:	68 dc 04 00 00       	push   $0x4dc
  f8:	e8 03 01 00 00       	call   200 <strlen>
  fd:	83 c4 0c             	add    $0xc,%esp
 100:	50                   	push   %eax
 101:	68 dc 04 00 00       	push   $0x4dc
 106:	6a 01                	push   $0x1
 108:	e8 e5 02 00 00       	call   3f2 <write>
    exit(0);
 10d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 114:	e8 b9 02 00 00       	call   3d2 <exit>
      exit(0);
 119:	83 ec 0c             	sub    $0xc,%esp
 11c:	6a 00                	push   $0x0
 11e:	e8 af 02 00 00       	call   3d2 <exit>
  write(fd, s, strlen(s));
 123:	83 ec 0c             	sub    $0xc,%esp
 126:	68 a7 04 00 00       	push   $0x4a7
 12b:	e8 d0 00 00 00       	call   200 <strlen>
 130:	83 c4 0c             	add    $0xc,%esp
 133:	50                   	push   %eax
 134:	68 a7 04 00 00       	push   $0x4a7
 139:	6a 01                	push   $0x1
 13b:	e8 b2 02 00 00       	call   3f2 <write>
      exit(0);
 140:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 147:	e8 86 02 00 00       	call   3d2 <exit>
  write(fd, s, strlen(s));
 14c:	83 ec 0c             	sub    $0xc,%esp
 14f:	68 bb 04 00 00       	push   $0x4bb
 154:	e8 a7 00 00 00       	call   200 <strlen>
 159:	83 c4 0c             	add    $0xc,%esp
 15c:	50                   	push   %eax
 15d:	68 bb 04 00 00       	push   $0x4bb
 162:	6a 01                	push   $0x1
 164:	e8 89 02 00 00       	call   3f2 <write>
    exit(0);
 169:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 170:	e8 5d 02 00 00       	call   3d2 <exit>
