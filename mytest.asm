...
int main(int argc, char *argv[])
{
  ...
  12:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
    pid = fork();
  19:	e8 8c 02 00 00       	call   2aa <fork>
    if (pid != 0){
  1e:	85 c0                	test   %eax,%eax
  20:	74 28                	je     4a <main+0x4a>
  22:	89 c3                	mov    %eax,%ebx
        wait(&status);
  24:	8d 45 f4             	lea    -0xc(%ebp),%eax
  27:	83 ec 0c             	sub    $0xc,%esp
  2a:	50                   	push   %eax
  2b:	e8 8a 02 00 00       	call   2ba <wait>
  ...
  4d:	6a 03                	push   $0x3
  4f:	e8 5e 02 00 00       	call   2b2 <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 9c 07 00 00       	mov    $0x79c,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 4c 0a 00 00    	cmp    %eax,0xa4c
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
}
 ...
 747:	0a 00 00 
 74a:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 50 0a 00 00       	mov    $0xa50,%eax
 759:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 760:	00 00 00 
